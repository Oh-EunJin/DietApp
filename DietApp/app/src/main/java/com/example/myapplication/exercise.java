...
public class exercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton imgbf = (ImageButton) findViewById(R.id.imageButton_e);


        imgbf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(exercise.this,ExChoActivity.class);
        ...
        LineDataSet lineDataSet = new LineDataSet(entries, "소모한 칼로리");
